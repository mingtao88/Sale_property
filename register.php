...
<html>
    ...
    <body>
        ...
        $querySelect = "SELECT company_id , name FROM company  ";
        ...
        <div class="container">
            ...
            <form id="defaultForm" class="form-horizontal" role="form" action="doRegister.php" method="post" data-toggle="validator">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"> 
                        <input type="text" class="form-control" id="mobile" name="mobile"  requried required data-error="Mobile number is required"/>
                        <div class="help-block with-errors"></div>
                </div>
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" name="company">
                        
                        <select class="form-control" id="company" name="company">
                            <?php for ($i=0 ; $i<count($arrResult); $i++){   ?>
                            <option value="<?php echo $arrResult[$i]['company_id']; ?>"> <?php echo $arrResult[$i]['name']; ?> </option>
                            <?php } ?>
                        </select>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <br>
                    ...
                    <div class="col-sm-10">
                        ...
                        required data-minlength="6"
                        data-minlength-error="Your password should be minimum 6 letters"
